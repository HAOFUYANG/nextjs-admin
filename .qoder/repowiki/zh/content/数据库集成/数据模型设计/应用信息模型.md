...
图表来源
- [src/app/(admin)/(others-pages)/(scene)/config/page.tsx:1-370](file://src/app/(admin)/(others-pages)/(scene)/config/page.tsx#L1-L370)
- [src/app/(admin)/(others-pages)/(scene)/config/new/page.tsx:1-293](file://src/app/(admin)/(others-pages)/(scene)/config/new/page.tsx#L1-L293)
...
- [src/app/(admin)/(others-pages)/(scene)/config/page.tsx:86-87](file://src/app/(admin)/(others-pages)/(scene)/config/page.tsx#L86-L87)
- [src/app/(admin)/(others-pages)/(scene)/config/new/page.tsx:97-98](file://src/app/(admin)/(others-pages)/(scene)/config/new/page.tsx#L97-L98)
...
章节来源
- [src/app/api/config/list/route.ts:7-77](file://src/app/api/config/list/route.ts#L7-L77)
- [src/app/(admin)/(others-pages)/(scene)/config/page.tsx:114-132](file://src/app/(admin)/(others-pages)/(scene)/config/page.tsx#L114-L132)
...
- 建议
  ...
  - 应用选项：在新增页缓存 /api/apps 的结果，减少重复拉取
