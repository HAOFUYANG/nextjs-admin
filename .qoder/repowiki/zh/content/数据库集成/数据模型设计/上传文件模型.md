...
## 项目结构
与上传文件模型直接相关的文件组织如下：
- 数据库模型定义：src/lib/file/schema.ts
...
- 上传API路由：src/app/api/upload/route.ts
...
subgraph "后端 API"
API_Upload["上传API<br/>POST /api/upload"]
API_List["列表查询 API"]
end
subgraph "数据库层"
...
**章节来源**
- [src/lib/file/schema.ts:7-12](file://src/lib/file/schema.ts#L7-L12)
...
**章节来源**
- [src/lib/file/schema.ts:10-11](file://src/lib/file/schema.ts#L10-L11)
