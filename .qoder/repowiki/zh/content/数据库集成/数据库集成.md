...
<cite>
**本文引用的文件**
- [apps/web/src/lib/db.ts](file://apps/web/src/lib/db.ts)
- [apps/web/src/lib/schema.ts](file://apps/web/src/lib/schema.ts)
- [apps/web/src/lib/table/schema.ts](file://apps/web/src/lib/table/schema.ts)
- [apps/web/src/lib/file/schema.ts](file://apps/web/src/lib/file/schema.ts)
- [apps/web/src/lib/app.ts](file://apps/web/src/lib/app.ts)
- [apps/web/src/app/api/config/list/route.ts](file://apps/web/src/app/api/config/list/route.ts)
- [apps/web/package.json](file://apps/web/package.json)
</cite>

## 更新摘要
**变更内容**
- 新增了完整的 Drizzle ORM 配置和数据库连接管理模块
- 添加了文件上传表的独立 schema 定义
- 完善了数据库迁移命令配置
- 更新了数据模型设计和表关系
- 增强了连接池管理和 SSL 处理机制
...
## 项目结构
数据库相关代码集中在以下位置：
- 连接与初始化：apps/web/src/lib/db.ts
- 模式聚合导出：apps/web/src/lib/schema.ts
- 表定义：apps/web/src/lib/table/schema.ts、apps/web/src/lib/file/schema.ts、apps/web/src/lib/app.ts
- API 查询接口：apps/web/src/app/api/config/list/route.ts
- 工具链脚本：apps/web/package.json 中的 drizzle-kit 命令

```mermaid
graph TB
subgraph "应用层"
API["API 路由<br/>apps/web/src/app/api/config/list/route.ts"]
end
subgraph "数据访问层"
DB["数据库连接<br/>apps/web/src/lib/db.ts"]
SCHEMA["模式聚合导出<br/>apps/web/src/lib/schema.ts"]
TABLE_SCHEMA["表定义<br/>apps/web/src/lib/table/schema.ts"]
FILE_SCHEMA["表定义<br/>apps/web/src/lib/file/schema.ts"]
APP_SCHEMA["表定义<br/>apps/web/src/lib/app.ts"]
end
subgraph "外部依赖"
DRIZZLE["drizzle-orm"]
PG["pg (PostgreSQL 驱动)"]
...
- [apps/web/src/lib/file/schema.ts:1-14](file://apps/web/src/lib/file/schema.ts#L1-L14)
...
- [apps/web/src/lib/table/schema.ts:3-25](file://apps/web/src/lib/table/schema.ts#L3-L25)
- [apps/web/src/lib/file/schema.ts:3-13](file://apps/web/src/lib/file/schema.ts#L3-L13)
- [apps/web/src/lib/app.ts:3-8](file://apps/web/src/lib/app.ts#L3-L8)
- [apps/web/src/app/api/config/list/route.ts:7-77](file://apps/web/src/app/api/config/list/route.ts#L7-L77)
...
**图表来源**
- [apps/web/src/app/api/config/list/route.ts:7-77](file://apps/web/src/app/api/config/list/route.ts#L7-L77)
- [apps/web/src/lib/db.ts:18](file://apps/web/src/lib/db.ts#L18)
- [apps/web/src/lib/schema.ts:15-17](file://apps/web/src/lib/schema.ts#L15-L17)
...
**图表来源**
- [apps/web/src/lib/db.ts:6-18](file://apps/web/src/lib/db.ts#L6-L18)
...
**图表来源**
- [apps/web/package.json:34](file://apps/web/package.json#L34)
- [apps/web/package.json:39](file://apps/web/package.json#L39)
- [apps/web/package.json:33](file://apps/web/package.json#L33)
- [apps/web/package.json:61](file://apps/web/package.json#L61)

**章节来源**
- [apps/web/package.json:17-82](file://apps/web/package.json#L17-L82)
...
- [apps/web/src/app/api/config/list/route.ts:67-76](file://apps/web/src/app/api/config/list/route.ts#L67-L76)

## 结论
本项目以 Drizzle ORM 为核心，结合 pg 驱动与连接池，实现了简洁而可扩展的数据访问层。通过模式聚合与类型推断，提升了开发效率与安全性；通过 API 路由实现了灵活的查询、分页与联表能力。新增的文件上传表定义和完善的迁移命令配置，进一步增强了系统的完整性和可维护性。建议后续在事务处理、索引优化与缓存策略方面进一步完善，以支撑更高并发与更复杂的数据需求。
